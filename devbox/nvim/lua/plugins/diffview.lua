-- Diffview - Git diff viewer with file panel on the right
return {
  {
    ...
    config = function()
      ...
      require("diffview").setup({
        ...
        keymaps = {
          ...
          view = {
            ...
            { "n", "<cr>",       actions.goto_file_split,             { desc = "Open the file in a new split" } },
            { "n", "gT",         actions.goto_file_tab,               { desc = "Open the file in a new tabpage" } },
      ...
      -- 快捷键：打开 diffview 显示 git 改动（右侧文件列表）
      vim.keymap.set("n", "<leader>gd", "<cmd>DiffviewOpen<cr>", { desc = "Open Git diff view (file panel on right)" })
      -- 快捷键：查看文件历史
